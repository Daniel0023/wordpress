	...
	<div class="copyrights">
		<div class="container">
			<div class="row" id="copyright-note">
				...
				<span><?php echo '&copy;' . esc_html(date_i18n(__('Y','one-pageily'))); ?> <?php bloginfo( 'name' ); ?><span class="footer-info-right"><?php echo esc_html_e(' | Theme:', 'one-pageily') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'one-pageily'); ?>"><?php echo esc_html_e('One Pageily', 'one-pageily') ?></a></span></span>
